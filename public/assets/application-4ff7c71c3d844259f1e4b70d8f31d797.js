...
$(function() {
  ...
  availableTags = ["Local Product Of Colorado", "Denver Relief", "The Green Solutionaf50", "The Green Solution4afc", "Karmaceuticals", "Infinite Wellness Center", "Natural Remedies", "Mbs Wellness Clinic", "Kind Love", "Ivita Wellness", "The Wellness Shop", "Herban Medicinals", "Ballpark Holistic Dispensary", "Strainwise The Ridge", "Colorado Care Facility", "Northwest Wellness Center", "Northern Lights Natural Rx", "Expanding Universe", "Herbal Remedies055f", "Denver Kush Club", "The Giving Tree Of Denver", "Allgreens", "Altitude Organic Medicine South6c8a", "Timberline Herbal Clinic   Wellness Center", "Leagle Services Llc", "Metro Cannabis Inc", "Riverside Wellness", "The Herbal Cure", "The Health Center", "Rocky Mountain High Denver", "Strainwise The Sanctuary", "Strainwise The Retreat", "Metropolis Medical", "Little Green Pharmacy", "Mile High Medical Cannabis", "Wellspring Collective", "3 D Denvers Discreet Dispensary", "Strainwise The Shelter", "Denco Alternative Medicine", "Strainwise The Haven", "Bgoods Apothecary", "Grassroots Grown", "Advanced Medical Alternatives", "The Clinic On Colfax", "Herbal Wellness", "Caregivers For Life", "The Releaf Center", "The Cherry Co", "Walking Raven", "Element Four20", "A Cut Above", "Citi Med", "Lodo Wellness Center", "Summit Wellness", "Kind Pain Management", "The Clinic On Holly", "Cure Dispensary", "Kindness", "Rocky Mountain Organics", "A Mile High Llc", "Alternative Wellness Center", "Urban Cannabis", "Burnzwell Mmc", "Medicine Man Glendale Dispensary"];

  $("#store_name").autocomplete({
    source: availableTags
  });

  $("#find-store-button").click(function(e) {
    e.prevent_default;
    console.log("yo");
    $('')
  });
  ...
  $("#find-store-form").submit(function(e) {
    ...
    $('#review-store-form h2').append(storeName);
